...
const Docs = () => {
  return (
    ...
    <div className="flex">
      <div className="w-1/4 p-4 overflow-y-auto fixed h-screen">
        <h2 className="text-xl font-bold mb-4">Table of Contents</h2>
        <ul className="space-y-2">
          <li><a href="#product">1.1 Product</a></li>
      ...
      <div className="w-3/4 p-4 ml-auto">
        ...
        <section id="product" className="mb-8">
          <h2 className="text-2xl font-bold mb-4">1.1 Product</h2>
          <p>
        ...
        <section id="background" className="mb-8">
          <h2 className="text-2xl font-bold mb-4">1.2 Background</h2>
          <p>
        ...
        <section id="objectives" className="mb-8">
          <h2 className="text-2xl font-bold mb-4">1.3 Objective(s)/Aim(s)/Target(s)</h2>
          <p>
        ...
        <section id="scope" className="mb-8">
          <h2 className="text-2xl font-bold mb-4">1.4 Scope</h2>
          <p>
        ...
        <section id="goals" className="mb-8">
          <h2 className="text-2xl font-bold mb-4">1.5 Business Goals</h2>
          <p>
